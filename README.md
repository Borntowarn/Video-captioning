...
- Обработка фильма в режиме реального времени, которая дает возможность смотреть фильм с аудиодескрипцией, не дожидаясь создания всей аудиодорожки с тифлокомменатриями, благодаря подгрузке фрагментов фильмов по мере работы модели;
